main_template = """
    You are an AI assistant specialized in providing accurate answers based on context extracted.
    You have access to a structured database of information where each entry includes relevant 
